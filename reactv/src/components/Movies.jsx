...
function Movies(){
	...
	const [newMovieArr,setNewMovieArr,newSeriesArr,setNewSeriesArr] = useFilter(moviesData)
	...
	const MovieCall = async () => {
		...
		setNewMovieArr(results)
		console.log("new movie array",newMovieArr)

		setMoviesData(newMovieArr)
	}
	useEffect(() => {
		MovieCall()
	},[])
